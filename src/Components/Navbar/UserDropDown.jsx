...
const UserDropDown = () => {
    ...
    const getAvatarSrc = () => {
        ...
        return `https://ui-avatars.com/api/?name=${userInfo?.username}&background=6366f1&color=fff&bold=true`;
    };
    ...
    return (
        <div className="dropdown dropdown-end">
                ...
                <div className="w-10 rounded-full ring-2 ring-transparent hover:ring-purple-400 dark:hover:ring-purple-500 transition-all duration-300">
                    <img
                        ...
                        onError={(e) => {
                            ...
                            e.target.src = `https://ui-avatars.com/api/?name=${userInfo?.username}&background=6366f1&color=fff`;
                        }}
                    />
                </div>
            </div>
            <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-white dark:bg-gray-800 rounded-2xl mt-3 w-64 p-2 shadow-2xl dark:shadow-gray-950/50 border border-gray-200 dark:border-gray-700 z-[100] transition-colors duration-300"
            >
