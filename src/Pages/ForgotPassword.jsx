...
import { FiShoppingBag, FiShield, FiMail, FiLock } from 'react-icons/fi'
                    ...
                    >
                        ...
                        <div className="space-y-4 pt-8">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-700 dark:text-gray-300">Recibirás un enlace por email</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-purple-100 dark:bg-purple-500/10 rounded-lg">
                                    <FiLock className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                                </div>
                                <span className="text-gray-700 dark:text-gray-300">Restablece tu contraseña de forma segura</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-purple-100 dark:bg-purple-500/10 rounded-lg">
                                    <FiShield className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                                </div>
                                <span className="text-gray-700 dark:text-gray-300">Protección de datos garantizada</span>
                            </div>
                        </div>
                    </motion.div>
